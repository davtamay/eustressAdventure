...
public enum EVENT_TYPE {
	...
	PROGRESS_RESTART_ALL,
	PROGRESS_RESTART_POSITION,
	GAME_INIT, 
	GAME_START,
	GAME_PAUSED,
	GAME_UNPAUSED,
...
public class EventManager : MonoBehaviour
{
	...
	public delegate void OnEvent(EVENT_TYPE Event_Type, Component Sender, params object[] Param);
	...
	void Start()
	{
		...
		AddListener (EVENT_TYPE.SCENE_LOADED, OnManagerEvent);
	...
	/// <param name="Param">arguments, type null if none</param>
	public void PostNotification(EVENT_TYPE Event_Type, Component Sender, params object[] Param)
	{
